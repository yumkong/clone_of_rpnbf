...
model.stage1_rpn.solver_def_file                = fullfile(pwd, 'models', exp_name, 'rpn_prototxts', 'vgg_leave','conv3_2d_centerloss', 'solver_30k40k_conv3_2d.prototxt'); 
model.stage1_rpn.test_net_def_file              = fullfile(pwd, 'models', exp_name, 'rpn_prototxts', 'vgg_leave','conv3_2d_centerloss', 'test_conv3_2d.prototxt');
