function dataset = create_imdb_ablation_512(dataset, usage, use_flip, event_pool, cache_dir)
...
switch usage
    case {'train'}
        ...
        %rot90+fliplr
        [dataset.imdb_train, dataset.roidb_train] = helper.imdb_from_widerface_ablation_512(devkit, 'trainval', use_flip, cache_dir, event_pool);
    case {'test'}
        [dataset.imdb_test, dataset.roidb_test] = helper.imdb_from_widerface_ablation_512(devkit, 'test', false, cache_dir, event_pool);
    otherwise
