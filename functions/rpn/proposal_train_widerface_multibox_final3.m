function save_model_path = proposal_train_widerface_multibox_final3(conf, imdb_train, roidb_train, varargin)
...
%% making tran/val data
    ...
    try
        ...
        [image_roidb_train, bbox_means_conv4, bbox_stds_conv4, bbox_means_conv5, bbox_stds_conv5, bbox_means_conv6, bbox_stds_conv6]...
                            = proposal_prepare_image_roidb_multibox_final3(conf, opts.imdb_train, opts.roidb_train);
...
%% -------------------- Training -------------------- 
    ...
    proposal_generate_minibatch_fun = @proposal_generate_minibatch_multibox_final3;
...
function rst = check_error(rst, caffe_solver)
    ...
    labels = caffe_solver.net.blobs('labels_reshape_conv6').get_data();
    labels_weights = caffe_solver.net.blobs('labels_weights_reshape_conv6').get_data();
