function [pred_boxes_conv4, scores_conv4, pred_boxes_conv5, scores_conv5, pred_boxes_conv6, scores_conv6] = proposal_im_detect_multibox_MPRPN_singleRatio(conf, caffe_net, im, im_idx)
...
% --------------------------------------------------------    
    ...
    [anchors_conv4, anchors_conv5, anchors_conv6] = proposal_locate_anchors_multibox_happy(conf, size(im), conf.test_scales);
...
%     pred_boxes_conv5 = pred_boxes_conv5(greater_mask(:),:);  % new pred_boxes
    ...
    [pred_boxes_conv5, scores_conv5] = filter_boxes(8, pred_boxes_conv5, scores_conv5);  %0103: 28--> 8
...
%     pred_boxes_conv6 = pred_boxes_conv6(greater_mask(:),:);  % new pred_boxes
    ...
    % drop too small boxes *** liu@1114: here tempararily set conv5's
    % thresh as 20, may change later (conv5 minimal anchor size is 32)
    [pred_boxes_conv6, scores_conv6] = filter_boxes(8, pred_boxes_conv6, scores_conv6);  %0103: 300--> 8
