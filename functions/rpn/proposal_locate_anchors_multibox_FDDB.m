function [anchors_conv4,anchors_conv5,anchors_conv6] = proposal_locate_anchors_multibox_FDDB(conf, im_size, feature_map_size)
...
% generate anchors for each scale
    ...
    [anchors_conv4,anchors_conv5,anchors_conv6] = func(im_size, conf, feature_map_size);
%     if exist('target_scale', 'var')
%         [anchors_conv4,anchors_conv5,anchors_conv6, im_scales] = func(im_size, conf, feature_map_size);
%     else
...
function [anchors_conv4,anchors_conv5,anchors_conv6] = proposal_locate_anchors_single_scale(im_size, conf, feature_map_size)
