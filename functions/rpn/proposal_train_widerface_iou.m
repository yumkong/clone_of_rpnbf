function save_model_path = proposal_train_widerface_iou(conf, imdb_train, roidb_train, varargin)
% save_model_path = proposal_train_widerface_iou(conf, imdb_train, roidb_train, varargin)
% --------------------------------------------------------
% RPN_BF
...
%% -------------------- Training -------------------- 
    ...
    proposal_generate_minibatch_fun = @proposal_generate_minibatch_iou;
...
%         fprintf('\n');
        ...
        %fprintf('%s = %.4f, ',rst(1).blob_name, rst(1).data); 
        %fprintf('%s = %.8f, ',rst(2).blob_name, rst(2).data); 
        %fprintf('%s = %.4f, ',rst(3).blob_name, rst(3).data); 
        %fprintf('%s = %.2f, ',rst(4).blob_name, rst(4).data); 
        %fprintf('%s = %.2f, ',rst(5).blob_name, rst(5).data); 
        fprintf('\n');
