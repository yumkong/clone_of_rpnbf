function aboxes = proposal_test_widerface_multibox(conf, imdb, varargin)
...
%% testing
        ...
        for i = 1:num_images
            ...
            %[boxes_conv4, scores_conv4, boxes_conv5, scores_conv5] = proposal_im_detect_multibox(conf, caffe_net, im);
