function save_model_path = proposal_train_widerface_multibox_ohem_ablation(conf, imdb_train, roidb_train, varargin)
...
%% init  
    ...
    %0314 changed
    caffe_solver.net.copy_from(fullfile(pwd, 'output', 'VGG16_widerface_multibox_ohem_ablation_compare', ...
        'rpn_cachedir','rpn_widerface_VGG16_stage1_rpn', 'WIDERFACE_train', 'iter_40000_1st'));
...
%% -------------------- Training -------------------- 
    ...
    proposal_generate_minibatch_fun = @proposal_generate_minibatch_ablation_divanchor_ohem;
    ...
    tmp_struct = struct('err_fg_s4', [], 'err_bg_s4', [], 'loss_cls_conv34', [], 'loss_bbox_conv34', [], ...
                        'err_fg_s8', [], 'err_bg_s8', [], 'loss_cls_conv5', [], 'loss_bbox_conv5', [], ...
                        'err_fg_s16', [], 'err_bg_s16', [], 'loss_cls_conv6', [], 'loss_bbox_conv6', []);
...
function model_path = snapshot(conf, caffe_solver, bbox_mean_s4, bbox_std_s4, bbox_mean_s8, bbox_std_s8,bbox_mean_s16, bbox_std_s16, cache_dir, file_name)
    ...
    bbox_pred_layer_name_s4 = 'proposal_bbox_pred_conv34'; %'proposal_bbox_pred_s4';
    ...
    % merge bbox_means, bbox_stds into the model
    bbox_pred_layer_name_s8 = 'proposal_bbox_pred_conv5'; %'proposal_bbox_pred_s8';
    ...
    % merge bbox_means, bbox_stds into the model
    bbox_pred_layer_name_s16 = 'proposal_bbox_pred_conv6'; %'proposal_bbox_pred_s16';
...
function history_rec = show_state_and_plot(iter, train_results, val_results, history_rec, modelFigPath1, modelFigPath2, modelFigPath3)
    ...
    history_rec.train.loss_cls_conv34 = [history_rec.train.loss_cls_conv34; mean(train_results.loss_cls_conv34.data)];
    history_rec.train.loss_bbox_conv34 = [history_rec.train.loss_bbox_conv34; mean(train_results.loss_bbox_conv34.data)];
    ...
    history_rec.val.loss_cls_conv34 = [history_rec.val.loss_cls_conv34; mean(val_results.loss_cls_conv34.data)];
    history_rec.val.loss_bbox_conv34 = [history_rec.val.loss_bbox_conv34; mean(val_results.loss_bbox_conv34.data)];
    %conv5
    ...
    plots1 = {'err_fg_s4', 'err_bg_s4', 'loss_cls_conv34', 'loss_bbox_conv34'};
    ...
    plots2 = {'err_fg_s8', 'err_bg_s8', 'loss_cls_conv5', 'loss_bbox_conv5'};
    ...
    plots3 = {'err_fg_s16', 'err_bg_s16', 'loss_cls_conv6', 'loss_bbox_conv6'};
