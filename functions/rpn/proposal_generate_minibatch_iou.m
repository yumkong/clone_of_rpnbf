function [input_blobs, random_scale_inds] = proposal_generate_minibatch_iou(conf, image_roidb)
% [input_blobs, random_scale_inds] = proposal_generate_minibatch_iou(conf, image_roidb)
% --------------------------------------------------------
% Faster R-CNN
