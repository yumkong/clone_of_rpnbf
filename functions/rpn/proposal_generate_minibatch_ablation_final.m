function [input_blobs, random_scale_inds] = proposal_generate_minibatch_ablation_final(conf, image_roidb)
...
%     end
    ...
    for i = 1:num_images
        ...
        labels_blob_conv4 = reshape(labels_conv4, size(conf.anchors_s4, 1), output_size_conv4(1), output_size_conv4(2));
        label_weights_blob_conv4 = reshape(label_weights_conv4, size(conf.anchors_s4, 1), output_size_conv4(1), output_size_conv4(2));
        bbox_targets_blob_conv4 = reshape(bbox_targets_conv4', size(conf.anchors_s4, 1)*4, output_size_conv4(1), output_size_conv4(2));
        bbox_loss_blob_conv4 = reshape(bbox_loss_conv4', size(conf.anchors_s4, 1)*4, output_size_conv4(1), output_size_conv4(2));
        ...
        labels_blob_conv5 = reshape(labels_conv5, size(conf.anchors_s8, 1), output_size_conv5(1), output_size_conv5(2));
        label_weights_blob_conv5 = reshape(label_weights_conv5, size(conf.anchors_s8, 1), output_size_conv5(1), output_size_conv5(2));
        bbox_targets_blob_conv5 = reshape(bbox_targets_conv5', size(conf.anchors_s8, 1)*4, output_size_conv5(1), output_size_conv5(2));
        bbox_loss_blob_conv5 = reshape(bbox_loss_conv5', size(conf.anchors_s8, 1)*4, output_size_conv5(1), output_size_conv5(2));
        % permute from [channel, height, width], where channel is the
        % fastest dimension to [width, height, channel]
        ...
        labels_blob_conv6 = reshape(labels_conv6, size(conf.anchors_s16, 1), output_size_conv6(1), output_size_conv6(2));
        label_weights_blob_conv6 = reshape(label_weights_conv6, size(conf.anchors_s16, 1), output_size_conv6(1), output_size_conv6(2));
        bbox_targets_blob_conv6 = reshape(bbox_targets_conv6', size(conf.anchors_s16, 1)*4, output_size_conv6(1), output_size_conv6(2));
        bbox_loss_blob_conv6 = reshape(bbox_loss_conv6', size(conf.anchors_s16, 1)*4, output_size_conv6(1), output_size_conv6(2));
        % permute from [channel, height, width], where channel is the
        % fastest dimension to [width, height, channel]
