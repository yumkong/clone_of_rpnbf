function [aboxes_conv4, aboxes_conv5] = proposal_test_widerface_multibox_final(conf, imdb, varargin)
...
%% testing
        ...
        for i = 1:num_images
            ...
            [boxes_conv4, scores_conv4, boxes_conv5, scores_conv5] = proposal_im_detect_multibox_final(conf, caffe_net, im);
        ...
        save(fullfile(cache_dir, ['proposal_boxes_' imdb.name opts.suffix]), 'aboxes_conv4', 'aboxes_conv5', '-v7.3');
