function [input_blobs, random_scale_inds] = proposal_generate_minibatch_conv4plus5(conf, image_roidb)
...
function [im_blob, im_scales] = get_image_blob(conf, images, random_scale_inds)
    ...
    for i = 1:num_images
        ...
        [im, im_scale] = prep_im_for_blob_conv4plus5(im, conf.image_means, target_size, conf.max_size);
