function [anchors_conv4, anchors_conv5, anchors_conv6] = proposal_generate_anchors_multibox_CRV(cache_name, varargin)
...
%         anchor_cache_file           = fullfile(anchor_cache_dir, 'anchors');
    ...
    try
        ...
        % 1112 added
        anchors_conv4 = anchors(1:3, :);  % [8  16 32]
        anchors_conv5 = anchors(3:7, :);  % [32 64 128 256 360]
        anchors_conv6 = anchors(6:end, :);  % [256 360 512 720 900]
        if ~opts.ignore_cache
