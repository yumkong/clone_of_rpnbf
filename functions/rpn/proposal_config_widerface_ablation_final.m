function conf = proposal_config_widerface_ablation_final(varargin)
...
%                                         true,           @islogical);
    ...
    ip.addParamValue('ims_per_batch',   5,              @isscalar);%0205:2-->3-->1
    % Minibatch size  0228: 360 (batch6) -> 240 (batch6)
    ip.addParamValue('batch_size',      200,            @isscalar); %original 120,0122: 256(for 1 image)  --> 240 (for 3 images) 
