function [aboxes_conv4, aboxes_conv5, aboxes_conv6] = proposal_test_widerface_multibox_happy_flip_vn7(conf, imdb, varargin)
...
%% testing
        ...
        for i = 1:num_images
            ...
            scores_conv4 = scores_conv4(scores_conv4 >= 0.1, :);
