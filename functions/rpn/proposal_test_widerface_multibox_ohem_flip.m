function [aboxes_conv4, aboxes_conv5, aboxes_conv6] = proposal_test_widerface_multibox_ohem_flip(conf, imdb, varargin)
...
%% testing
        ...
        for i = 1:num_images
            ...
            [boxes_conv4, scores_conv4, boxes_conv5, scores_conv5, boxes_conv6, scores_conv6] = proposal_im_detect_multibox_ohem_flip(conf, caffe_net, im);
