function save_model_path = proposal_train_widerface_conv345(conf, imdb_train, roidb_train, varargin)
...
%% making tran/val data
    ...
    try
        ...
        [image_roidb_train, bbox_means, bbox_stds]...
                            = proposal_prepare_image_roidb_conv345(conf, opts.imdb_train, opts.roidb_train);
    ...
    if opts.do_val
        ...
        try
            ...
            [image_roidb_val]...
                                = proposal_prepare_image_roidb_conv345(conf, opts.imdb_val, opts.roidb_val, bbox_means, bbox_stds);
...
%% -------------------- Training -------------------- 
    ...
    proposal_generate_minibatch_fun = @proposal_generate_minibatch_conv345;
