function save_model_path = proposal_train_widerface_multibox_ohem(conf, imdb_train, roidb_train, varargin)
...
%% -------------------- Training -------------------- 
    ...
    proposal_generate_minibatch_fun = @proposal_generate_minibatch_multibox_ohem;
