function aboxes = proposal_test_widerface_hwRatio(conf, imdb, varargin)
...
%% testing
        ...
        for i = 1:num_images
            ...
            [boxes, scores, abox_deltas{i}, aanchors{i}, ascores{i}] = proposal_im_detect_hwRatio(conf, caffe_net, im);
