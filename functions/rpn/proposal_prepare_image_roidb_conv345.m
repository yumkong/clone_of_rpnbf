function [image_roidb, bbox_means, bbox_stds] = proposal_prepare_image_roidb_conv345(conf, imdbs, roidbs, bbox_means, bbox_stds)
...
function [image_roidb, means, stds] = append_bbox_regression_targets(conf, image_roidb, means, stds)
    ...
    for i = 1:num_images
       ...
       [anchors, im_scales] = proposal_locate_anchors_conv345(conf, image_roidb_cell{i}.im_size);
