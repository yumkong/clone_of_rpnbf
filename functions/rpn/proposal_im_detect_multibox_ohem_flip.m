function [pred_boxes_conv4, scores_conv4, pred_boxes_conv5, scores_conv5, pred_boxes_conv6, scores_conv6] = proposal_im_detect_multibox_ohem_flip(conf, caffe_net, im, im_idx)
%function [pred_boxes, scores] = proposal_im_detect_multibox_final(conf, caffe_net, im, im_idx)
...
% --------------------------------------------------------    
    ...
    anchor_num = size(conf.anchors_conv4, 1);  %14
    ...
    scores_conv4 = scores_conv4(greater_mask(:),:);  %new scores
    pred_boxes_conv4 = pred_boxes_conv4(greater_mask(:),:);  % new pred_boxes
    %====== end of 1025
