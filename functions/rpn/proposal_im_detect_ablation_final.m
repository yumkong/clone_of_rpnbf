function [pred_boxes_conv4, scores_conv4, pred_boxes_conv5, scores_conv5, pred_boxes_conv6, scores_conv6] = proposal_im_detect_ablation_final(conf, caffe_net, im, im_idx)
