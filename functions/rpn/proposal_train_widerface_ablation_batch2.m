function save_model_path = proposal_train_widerface_ablation_batch2(conf, imdb_train, roidb_train, varargin)
...
%% -------------------- Training -------------------- 
    ...
    proposal_generate_minibatch_fun = @proposal_generate_minibatch_batch2;
