function conf = proposal_config_widerface_twopath_happy_batch2_vn7(varargin)
...
%                                         true,           @islogical);
    ...
    ip.addParamValue('ims_per_batch',   2,              @isscalar);%0122 1->2
    % Minibatch size
    ip.addParamValue('batch_size',      160,            @isscalar);%0122 256->160: 80 boxes/image
