function [image_roidb, bbox_means, bbox_stds] = proposal_prepare_image_roidb_yolo(conf, imdbs, roidbs, bbox_means, bbox_stds)
...
%   negative: [-1, zero(regression_label)]
    ...
    [regression_label] = fast_rcnn_bbox_transform_yolo(src_rois, target_rois);
