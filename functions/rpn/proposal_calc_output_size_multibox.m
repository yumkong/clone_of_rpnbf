function [output_width_map_conv4, output_height_map_conv4, output_width_map_conv5, output_height_map_conv5] = proposal_calc_output_size_multibox(conf, test_net_def_file, output_map_save_name)
