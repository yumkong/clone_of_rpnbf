...
%                                         true,           @islogical);
    ...
    ip.addParamValue('batch_size_s4',      200,            @isscalar); %40/batch
    ip.addParamValue('batch_size_s8',      200,            @isscalar); %40/batch
    ip.addParamValue('batch_size_s16',     200,            @isscalar); %40/batch
