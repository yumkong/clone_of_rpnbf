...
%                                         true,           @islogical);
    ...
    ip.addParamValue('batch_size_s4',      96,            @isscalar); %40/batch
    ip.addParamValue('batch_size_s8',      144,            @isscalar); %40/batch
    ip.addParamValue('batch_size_s16',     48,            @isscalar); %40/batch
