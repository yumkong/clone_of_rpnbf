function save_model_path = proposal_train_widerface_twopath_happy(conf, imdb_train, roidb_train, varargin)
...
%% -------------------- Training -------------------- 
    ...
    proposal_generate_minibatch_fun = @proposal_generate_minibatch_twopath_happy;
