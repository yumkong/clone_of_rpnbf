function [pred_boxes_conv4, scores_conv4, pred_boxes_conv5, scores_conv5, pred_boxes_conv6, scores_conv6] = proposal_im_detect_multibox_ablation(conf, caffe_net, im, im_idx)
...
% --------------------------------------------------------    
    ...
    [anchors_conv4, anchors_conv5, anchors_conv6] = proposal_locate_anchors_multibox_ablation(conf, size(im), conf.test_scales);
