function [aboxes_s4, aboxes_s8, aboxes_s16] = proposal_test_widerface_ablation_FDDB_scale3(conf, varargin)
...
%% inputs
    ...
    cache_dir = fullfile(pwd, 'output', conf.exp_name, 'rpn_cachedir', opts.cache_name, 'FDDB_test');
...
%% testing
        ...
        save(fullfile(cache_dir, ['proposal_boxes_FDDB' opts.suffix]), 'aboxes_s4', 'aboxes_s8', 'aboxes_s16', '-v7.3');
