function [aboxes_s4, aboxes_s8, aboxes_s16] = proposal_test_widerface_ablation_final_flip(conf, imdb, varargin)
...
%% testing
        ...
        for i = 1:num_images
            ...
            [boxes_s4, scores_s4, boxes_s8, scores_s8, boxes_s16, scores_s16] = proposal_im_detect_ablation_final_flip(conf, caffe_net, im);
            ...
            aboxes_s16{i} = [boxes_s16, scores_s16];
