function mAP = fast_rcnn_test_widerface_ablation_0401(conf, imdb, roidb, varargin)
...
%%      testing 
        ...
        for i = 1:num_images
            ...
            fastrcnn_score = fast_rcnn_im_detect_widerface_ablation(conf, caffe_net, im, rpn_boxes, max_rois_num_in_gpu);
