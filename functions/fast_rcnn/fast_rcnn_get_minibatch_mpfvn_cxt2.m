function [im_blob, rois_blob_s4, rois_cxt_blob_s4,rois_blob_s8, rois_cxt_blob_s8,rois_blob_s16, rois_cxt_blob_s16, labels_blob] = fast_rcnn_get_minibatch_mpfvn_cxt2(conf, image_roidb)
...
% --------------------------------------------------------
    ...
    for i = 1:num_images
        ...
        [feat_rois_s4, feat_cxt_rois_s4, feat_rois_s8, feat_cxt_rois_s8, feat_rois_s16, feat_cxt_rois_s16] = fast_rcnn_map_im_rois_to_feat_rois_mpfvn2(conf, im_rois_s4, im_rois_s8, im_rois_s16, im_scales(i), image_roidb(i).im_size);
