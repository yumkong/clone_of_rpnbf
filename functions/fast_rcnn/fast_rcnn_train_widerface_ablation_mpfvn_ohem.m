function save_model_path = fast_rcnn_train_widerface_ablation_mpfvn_ohem(conf, imdb_train, roidb_train, varargin)
...
%% training
    ...
    while (iter_ <= max_iter)
        ...
        [im_blob, rois_blob_s4, rois_cxt_blob_s4, rois_blob_s8, rois_cxt_blob_s8, rois_blob_s16, rois_cxt_blob_s16, labels_blob] = ...
            fast_rcnn_get_minibatch_mpfvn_ohem(conf, image_roidb_train(sub_db_inds));
        ...
        if ~mod(iter_, opts.val_interval) 
            if opts.do_val
                ...
                for i = 1:length(shuffled_inds_val)
                    ...
                    [im_blob, rois_blob_s4, rois_cxt_blob_s4, rois_blob_s8, rois_cxt_blob_s8, rois_blob_s16, rois_cxt_blob_s16, labels_blob] = ...
                        fast_rcnn_get_minibatch_mpfvn_cxt(conf, image_roidb_val(sub_db_inds));
