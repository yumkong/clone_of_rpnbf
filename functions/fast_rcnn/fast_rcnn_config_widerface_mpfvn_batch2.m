function conf = fast_rcnn_config_widerface_mpfvn_batch2(varargin)
...
%
    ...
    ip.addParamValue('batch_size_s4',    32,            @isscalar); %0325: 32 (for 2 images)
    ip.addParamValue('batch_size_s8',    48,            @isscalar); %0325: 48 (for 2 images)
    ip.addParamValue('batch_size_s16',   16,            @isscalar); %0325: 16 (for 2 images)
