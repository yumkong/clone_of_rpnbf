function [im_blob, rois_blob_s4, rois_cxt_blob_s4,rois_blob_s8, rois_cxt_blob_s8,rois_blob_s16, rois_cxt_blob_s16, labels_blob] = fast_rcnn_get_minibatch_mpfvn_cxt(conf, image_roidb)
