function save_model_path = fast_rcnn_train_widerface_ablation_mpfvn_nocxt(conf, imdb_train, roidb_train, varargin)
...
%% training
    ...
    while (iter_ <= max_iter)
        ...
        [im_blob, rois_blob_s4, rois_blob_s8, rois_blob_s16, labels_blob] = ...
            fast_rcnn_get_minibatch_mpfvn_nocxt(conf, image_roidb_train(sub_db_inds));

        %net_inputs = {im_blob, rois_blob, labels_blob, bbox_targets_blob, bbox_loss_weights_blob};
        net_inputs = {im_blob, rois_blob_s4, rois_blob_s8, rois_blob_s16, labels_blob};
        ...
        if ~mod(iter_, opts.val_interval) 
            if opts.do_val
                ...
                for i = 1:length(shuffled_inds_val)
                    ...
                    [im_blob, rois_blob_s4, rois_blob_s8, rois_blob_s16, labels_blob] = ...
                        fast_rcnn_get_minibatch_mpfvn_nocxt(conf, image_roidb_val(sub_db_inds));
