function scores = fast_rcnn_im_detect_widerface_mpfvn_nocxt(conf, caffe_net, im, boxes)
...
% --------------------------------------------------------
    ...
    [im_blob, rois_s4, rois_s8, rois_s16, ~, score_mask, ind_inv] = get_blobs(conf, im, boxes);
    ...
    net_inputs = {im_blob, rois_blob_s4, rois_blob_s8, rois_blob_s16};
...
function [data_blob, rois_s4, rois_s8, rois_s16, im_scale_factors, score_mask, ind_inv] = get_blobs(conf, im, rois)
    ...
    [rois_s4, rois_s8, rois_s16] = get_rois_blob(conf, rois_s4, rois_s8, rois_s16, im_scale_factors, size(im));
end
...
function [rois_blob_s4, rois_blob_s8, rois_blob_s16] = get_rois_blob(conf, ...
                                            rois_s4, rois_s8, rois_s16, im_scale_factors, im_siz)
    [feat_rois_s4,feat_rois_s8,feat_rois_s16] = map_im_rois_to_feat_rois(conf, rois_s4, rois_s8, rois_s16, im_scale_factors, im_siz);
    % stride 4
...
function [feat_rois_s4,feat_rois_s8,feat_rois_s16] = map_im_rois_to_feat_rois(conf, rois_s4, rois_s8, rois_s16, scales, im_siz)
