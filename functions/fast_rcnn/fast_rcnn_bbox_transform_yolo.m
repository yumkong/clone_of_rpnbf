function [regression_label] = fast_rcnn_bbox_transform_yolo(ex_boxes, gt_boxes)
...
% --------------------------------------------------------
    ...
    targets_dx = nthroot(targets_dx, 3);  % real cubic root
    targets_dy = nthroot(targets_dy, 3);  % real cubic root
    targets_dw = nthroot(targets_dw, 3);  % real cubic root
    targets_dh = nthroot(targets_dh, 3);  % real cubic root
