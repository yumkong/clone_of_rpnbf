function mAP = fast_rcnn_test_widerface_conv3_4_batch2(conf, imdb, roidb, varargin)
...
%%      testing 
        ...
        for i = 1:num_images
            ...
            [boxes, scores] = fast_rcnn_im_detect_widerface(conf, caffe_net, im, d.boxes, max_rois_num_in_gpu);
