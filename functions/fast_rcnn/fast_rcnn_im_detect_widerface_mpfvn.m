function scores = fast_rcnn_im_detect_widerface_mpfvn(conf, caffe_net, im, boxes)
...
% --------------------------------------------------------
    ...
    [im_blob, rois_s4, rois_cxt_s4, rois_s8, rois_cxt_s8, rois_s16, rois_cxt_s16, ~, score_mask] = get_blobs(conf, im, boxes);
...
function [data_blob, rois_s4, rois_cxt_s4, rois_s8, rois_cxt_s8, rois_s16, rois_cxt_s16, im_scale_factors, score_mask] = get_blobs(conf, im, rois)
    ...
    if ~isempty(rois)
        ...
        ind_s4 = (face_hei < 12);
        ind_s8 = (face_hei >= 12 & face_hei < 120);
        ind_s16 = (face_hei >= 120);
        rois_s4 = rois(ind_s4, :);
        rois_s8 = rois(ind_s8, :);
