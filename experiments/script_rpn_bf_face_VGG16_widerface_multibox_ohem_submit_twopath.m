...
BF_prototxt_path = fullfile('models', 'VGG16_widerface', 'bf_prototxts', 'test_feat_conv34atrous_multibox_ohem.prototxt'); %test_feat_conv34atrous_v2
...
show_image = true;
write_bbox = false;  %1214 added: whether to write resulting bbox to txt file
