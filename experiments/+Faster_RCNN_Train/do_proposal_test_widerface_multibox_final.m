function do_proposal_test_widerface_multibox_final(conf, model_stage, imdb, roidb, cache_name, method_name, nms_option)

    [aboxes_conv4, aboxes_conv5]            = proposal_test_widerface_multibox_final(conf, imdb, ...
    ...
    fprintf('score_threshold conv4 = %f, conv5\n', score_thresh_conv4, score_thresh_conv5);
