function do_proposal_test_widerface_ablation_total_2345_realtest(conf,conf_fast_rcnn, model_stage, model_stage_fast, imdb, nms_option)
...
%     SUBMIT_cachedir2 = fullfile(pwd, 'output', conf_fast_rcnn.exp_name, 'fast_rcnn_cachedir', 'realtest_BP-FPN_cachedir2');
%     mkdir_if_missing(SUBMIT_cachedir2);
%     SUBMIT_cachedir3 = fullfile(pwd, 'output', conf_fast_rcnn.exp_name, 'fast_rcnn_cachedir', 'realtest_BP-FPN_cachedir3');
%     mkdir_if_missing(SUBMIT_cachedir3);
%     SUBMIT_cachedir4 = fullfile(pwd, 'output', conf_fast_rcnn.exp_name, 'fast_rcnn_cachedir', 'realtest_BP-FPN_cachedir4');
%     mkdir_if_missing(SUBMIT_cachedir4);
%     SUBMIT_cachedir5 = fullfile(pwd, 'output', conf_fast_rcnn.exp_name, 'fast_rcnn_cachedir', 'realtest_BP-FPN_cachedir5');
