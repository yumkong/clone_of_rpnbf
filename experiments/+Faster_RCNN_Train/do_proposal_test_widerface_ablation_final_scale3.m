function do_proposal_test_widerface_ablation_final_scale3(conf, model_stage, imdb, roidb, nms_option)
    ...
    % s16
    sample_aboxes = aboxes_s8(randperm(length(aboxes_s16), min(length(aboxes_s16), max_sample_num)));  % conv4 and conv5 are the same, so just use conv4
