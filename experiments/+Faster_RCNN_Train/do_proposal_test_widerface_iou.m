function aboxes = do_proposal_test_widerface_iou(conf, model_stage, imdb, roidb, cache_name, method_name, nms_option)
    aboxes                      = proposal_test_widerface_iou(conf, imdb, ...
