function do_proposal_test_widerface_ablation_total_2345_MALF(conf,conf_fast_rcnn, model_stage, model_stage_fast, nms_option)
    ...
    [aboxes_s4, aboxes_s8, aboxes_s16]  = proposal_test_widerface_ablation_MALF_scale3(conf, ...
    ...
    cache_dir = fullfile(pwd, 'output', fopts.exp_name, 'fast_rcnn_cachedir', fopts.cache_name, 'MALF_test'); 
    ...
    save_file = fullfile(cache_dir, ['aboxes_MALF' fopts.suffix]);
...
%     [num_images, fileList] = FDDB_ReadList(listFile);
	...
	SUBMIT_cachedir = fullfile(pwd, 'output', conf.exp_name, 'submit_mpfvn_MALF_cachedir');  %submit_mprpn_FDDB_cachedir
