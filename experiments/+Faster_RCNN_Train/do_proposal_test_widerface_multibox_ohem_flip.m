function do_proposal_test_widerface_multibox_ohem_flip(conf, model_stage, imdb, roidb, cache_name, method_name, nms_option)
    % share the test with final3 for they have the same test network struct
    [aboxes_conv4, aboxes_conv5, aboxes_conv6]     = proposal_test_widerface_multibox_ohem_flip(conf, imdb, ...
