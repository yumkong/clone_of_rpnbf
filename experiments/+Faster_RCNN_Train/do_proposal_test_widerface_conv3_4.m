function aboxes = do_proposal_test_widerface_conv3_4(conf, model_stage, imdb, roidb, nms_option)
    aboxes                      = proposal_test_widerface_conv3_4(conf, imdb, ...
                                        'net_def_file',     model_stage.test_net_def_file, ...
                                        'net_file',         model_stage.output_model_file, ...
                                        'cache_name',       model_stage.cache_name, ...
                                        'three_scales',     true); %0124: root switch of test with 1 scale or 3 scales
