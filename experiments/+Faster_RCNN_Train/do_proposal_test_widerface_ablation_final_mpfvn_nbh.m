function do_proposal_test_widerface_ablation_final_mpfvn_nbh(conf,conf_fast_rcnn, model_stage,model_stage_fast, imdb, roidb, nms_option)
    ...
    [aboxes_s4, aboxes_s8, aboxes_s16]  = proposal_test_widerface_ablation_final_scale3_nbh(conf, imdb, ...
                                        'net_def_file',     model_stage.test_net_def_file, ...
                                        'net_file',         model_stage.output_model_file, ...
                                        'cache_name',       model_stage.cache_name, ...
                                        'suffix',           '_thr_60_60_60_nbh'); 
