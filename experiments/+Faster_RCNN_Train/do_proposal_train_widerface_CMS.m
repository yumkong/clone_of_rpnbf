function model_stage = do_proposal_train_widerface_CMS(conf, dataset, model_stage, do_val)
    if ~do_val
    ...
    model_stage.output_model_file = proposal_train_widerface_CMS(conf, dataset.imdb_train, dataset.roidb_train, ...
                                    'do_val',           do_val, ...
