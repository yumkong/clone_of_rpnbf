function script_VGG16_widerface_ablation_total_conv2345_cxt_realtest()
...
Faster_RCNN_Train.do_proposal_test_widerface_ablation_total_2345_cxt_real(conf_proposal, conf_fast_rcnn, model.stage1_rpn, model.stage1_fast_rcnn, dataset.imdb_realtest, nms_option_test);
end
