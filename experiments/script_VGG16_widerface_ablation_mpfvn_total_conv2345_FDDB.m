function script_VGG16_widerface_ablation_mpfvn_total_conv2345_FDDB()
...
opts.do_val                 = true; 
% model
model                       = Model.VGG16_for_mpfvn_ablation_FDDB_conv2345_deconv(exp_name);
% cache base
...
Faster_RCNN_Train.do_proposal_test_widerface_ablation_total_2345_FDDB(conf_proposal, conf_fast_rcnn, model.stage1_rpn, model.stage1_fast_rcnn, nms_option_test);
end
