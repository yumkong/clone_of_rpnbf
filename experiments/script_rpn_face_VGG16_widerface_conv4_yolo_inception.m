function script_rpn_face_VGG16_widerface_conv4_yolo_inception()
...
% cache base
cache_base_proposal         = 'yolo_inception_widerface_VGG16';
% model
model                       = Model.VGG16_for_rpn_widerface_conv4_yolo_inception(exp_name, cache_base_proposal);
