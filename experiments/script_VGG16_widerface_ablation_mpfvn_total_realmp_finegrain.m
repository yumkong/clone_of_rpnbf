function script_VGG16_widerface_ablation_mpfvn_total_realmp_finegrain()
...
opts.do_val                 = true; 
% model
model                       = Model.VGG16_for_mpfvn_ablation_total_realmp_finegrain(exp_name);
% cache base
...
conf_fast_rcnn              = fast_rcnn_config_widerface_mpfvn_total_realmp_finegrain('image_means', model.mean_image);
...
model.stage1_fast_rcnn      = Faster_RCNN_Train.do_fast_rcnn_train_widerface_total_realmp_finegrain(conf_fast_rcnn, dataset, model.stage1_fast_rcnn, opts.do_val);
% test
Faster_RCNN_Train.do_fast_rcnn_test_widerface_total_realmp_finegrain(conf_fast_rcnn, model.stage1_fast_rcnn, dataset.imdb_test, dataset.roidb_test);
end
