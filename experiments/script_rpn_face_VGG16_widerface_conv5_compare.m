function script_rpn_face_VGG16_widerface_conv5_compare()
...
opts.do_val                 = true; 
% model
model                       = Model.VGG16_for_rpn_widerface_conv5_compare(exp_name);
% cache base
...
exp_name = 'VGG16_widerface_conv5_compare';
