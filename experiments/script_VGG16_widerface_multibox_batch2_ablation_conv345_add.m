function script_VGG16_widerface_multibox_batch2_ablation_conv345_add()
...
opts.do_val                 = true; 
% model
model                       = Model.VGG16_for_multibox_batch2_ablation_conv345_add(exp_name);
% cache base
...
exp_name = 'VGG16_widerface_multibox_ablation_conv345_elmadd_s4';
