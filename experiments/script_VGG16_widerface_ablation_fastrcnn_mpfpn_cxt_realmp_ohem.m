function script_VGG16_widerface_ablation_fastrcnn_mpfpn_cxt_realmp_ohem()
...
opts.do_val                 = true; 
% model
model                       = Model.VGG16_for_ablation_fastrcnn_mpfpn_cxt_realmp_ohem(exp_name);
% cache base
...
model.stage1_fast_rcnn      = Faster_RCNN_Train.do_fast_rcnn_train_widerface_ablation_mpfvn_cxt_realmp_ohem(conf_fast_rcnn, dataset, model.stage1_fast_rcnn, opts.do_val);
% test
