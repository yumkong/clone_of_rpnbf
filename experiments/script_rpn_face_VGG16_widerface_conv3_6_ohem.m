function script_rpn_face_VGG16_widerface_conv3_6_ohem()
...
opts.do_val                 = true; 
% model
model                       = Model.VGG16_for_rpn_widerface_conv3_6_ohem(exp_name);
% cache base
...
exp_name = 'VGG16_widerface_conv3_6_ohem';
...
model.stage1_rpn            = Faster_RCNN_Train.do_proposal_train_widerface_conv3_4_ohem(conf_proposal, dataset, model.stage1_rpn, opts.do_val);
