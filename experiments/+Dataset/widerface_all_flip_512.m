function dataset = widerface_all_flip_512(dataset, usage, use_flip, event_num, cache_dir, model_name_base)
...
switch usage
    case {'train'}
        ...
        %rot90+fliplr
        [dataset.imdb_train, dataset.roidb_train] = imdb_from_widerface_flip_512(devkit, 'trainval', use_flip, cache_dir, model_name_base, event_num);
    case {'test'}
