...
if ispc
    opts.caffe_version          = 'caffe_faster_rcnn_win_cudnn_bn'; %'caffe_faster_rcnn_win_cudnn_newL1'; %'caffe_faster_rcnn_win_cudnn_bn'
    cd('D:\\RPN_BF_master');
elseif isunix
    ...
    opts.caffe_version          = 'caffe_faster_rcnn_bn';  %'caffe_faster_rcnn_newL1'; %'caffe_faster_rcnn_bn'; 
...
output_map_name = 'output_map_res4';  % output_map_res5
