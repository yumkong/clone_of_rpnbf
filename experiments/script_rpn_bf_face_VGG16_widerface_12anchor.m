function script_rpn_bf_face_VGG16_widerface_12anchor()
...
model.stage1_rpn.nms.nms_overlap_thres = 0.7; %1010: 0.7 --> 0.8
model.stage1_rpn.nms.after_nms_topN = 1000;  % 1010: 1000 --> 600
...
%if 1 % set to 1 for visual
    ...
    fid = fopen(fullfile(cache_dir1, 'VGG16_e1-e3-RPN+BF-anchor12-ave-300-nms-op3-newscore2.txt'), 'w+');
