function script_res_widerface_twopath_happy_flip_batch2_e1_e11_fpn2()
...
opts.do_val                 = true; 
% model
model                       = Model.Res101_for_rpn_widerface_twopath_batch2_fpn2(exp_name);
% cache base
...
exp_name = 'Res16_widerface_twopath_e1-e11_fpn2';
