function script_VGG16_widerface_multibox_ablation_total_mpfvn_draw()
...
Faster_RCNN_Train.do_proposal_test_widerface_ablation_final_draw(conf_proposal, model.stage1_rpn, dataset.imdb_test, dataset.roidb_test, nms_option_test);
