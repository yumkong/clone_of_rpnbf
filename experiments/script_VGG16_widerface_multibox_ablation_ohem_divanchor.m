function script_VGG16_widerface_multibox_ablation_ohem_divanchor()
...
opts.do_val                 = true; 
% model
model                       = Model.VGG16_for_multibox_batch2_ablation_divanchor_ohem(exp_name);
% cache base
...
exp_name = 'VGG16_widerface_multibox_ablation_ohem_divanchor';
