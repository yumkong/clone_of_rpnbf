function script_VGG16_widerface_multibox_batch2_ablation_all_moreanchor()
...
opts.do_val                 = true; 
% model
model                       = Model.VGG16_for_multibox_batch2_ablation_all_moreanchor(exp_name);
% cache base
...
exp_name = 'VGG16_widerface_multibox_ablation_final3_moreanchor';
...
[conf_proposal.anchors_s4,conf_proposal.anchors_s8, conf_proposal.anchors_s16] = proposal_generate_anchors_ablation_final_moreanchor(cache_data_this_model_dir, ...
                         'ratios', [1], 'scales',  2.^[-1:4], 'add_size', [10 24 48 96 192 384 480]);  %[8 16 32 64 128 256 480]
