function model = VGG16_for_rpn_widerface_conv4_hwRatio(exp_name, model)
...
model.stage1_rpn.solver_def_file                = fullfile(pwd, 'models', exp_name, 'rpn_prototxts', 'vgg_16layers_conv3_1', 'solver_60k80k_widerface_conv4_hwRatio.prototxt'); %solver_60k80k_widerface_12anchor
model.stage1_rpn.test_net_def_file              = fullfile(pwd, 'models', exp_name, 'rpn_prototxts', 'vgg_16layers_conv3_1', 'test_widerface_conv4_hwRatio.prototxt');
model.stage1_rpn.init_net_file                  = model.pre_trained_net_file;

% rpn test setting
model.stage1_rpn.nms.per_nms_topN               = -1; %20000
model.stage1_rpn.nms.nms_overlap_thres       	= 1;%0.7
model.stage1_rpn.nms.after_nms_topN         	= 500;  %1019: 300 --> 500, since #anchor is doubled
...
model.stage1_fast_rcnn.test_net_def_file        = fullfile(pwd, 'models', exp_name,'fast_rcnn_prototxts', 'vgg_16layers_conv3_1', 'test_widerface_conv4.prototxt');
model.stage1_fast_rcnn.init_net_file            = model.pre_trained_net_file;

%% stage 2 rpn, only finetune fc layers
model.stage2_rpn.solver_def_file                = fullfile(pwd, 'models', exp_name,'rpn_prototxts', 'vgg_16layers_fc6', 'solver_60k80k_widerface_conv4.prototxt');
model.stage2_rpn.test_net_def_file              = fullfile(pwd, 'models', exp_name,'rpn_prototxts', 'vgg_16layers_fc6', 'test_widerface_conv4.prototxt');
...
model.stage2_fast_rcnn.test_net_def_file        = fullfile(pwd, 'models', exp_name,'fast_rcnn_prototxts', 'vgg_16layers_fc6', 'test_widerface_conv4.prototxt');
