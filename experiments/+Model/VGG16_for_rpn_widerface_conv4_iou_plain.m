function model = VGG16_for_rpn_widerface_conv4_iou_plain(exp_name, cache_base_proposal, model)
...
model.stage1_rpn.solver_def_file                = fullfile(pwd, 'models', exp_name, 'rpn_prototxts', 'vgg_16layers_iou', 'solver_60k80k_widerface_conv4_iou_plain.prototxt'); 
model.stage1_rpn.test_net_def_file              = fullfile(pwd, 'models', exp_name, 'rpn_prototxts', 'vgg_16layers_iou', 'test_widerface_conv4_iou_plain.prototxt');
