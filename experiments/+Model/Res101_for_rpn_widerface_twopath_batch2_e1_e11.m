function model = Res101_for_rpn_widerface_twopath_batch2_e1_e11(exp_name, model)
...
model.stage1_rpn.solver_def_file                = fullfile(pwd, 'models', exp_name, 'rpn_prototxts', 'res101', 'solver_300k400k_e1_e11.prototxt'); 
model.stage1_rpn.test_net_def_file              = fullfile(pwd, 'models', exp_name, 'rpn_prototxts', 'res101', 'test_e1_e11.prototxt');
