function model = VGG16_for_ablation_fastrcnn_mpfpn_cxt_ohem(exp_name, model)
...
model.stage1_fast_rcnn.solver_def_file          = fullfile(pwd, 'models', exp_name,'rpn_prototxts', 'vgg_16layers_ablation', 'final_model_stage2_vn7','solver_60k80k_stage2_mpfpn_cxt_ohem.prototxt');
model.stage1_fast_rcnn.test_net_def_file        = fullfile(pwd, 'models', exp_name,'rpn_prototxts', 'vgg_16layers_ablation', 'final_model_stage2_vn7', 'test_stage2_mpfpn_cxt_ohem.prototxt');
end