...
model.stage1_rpn.solver_def_file                = fullfile(pwd, 'models', exp_name, 'rpn_prototxts', 'res101_ablation', 'solver_30k40k_conv4_2.prototxt'); %conv5
model.stage1_rpn.test_net_def_file              = fullfile(pwd, 'models', exp_name, 'rpn_prototxts', 'res101_ablation', 'test_conv4_2.prototxt');
