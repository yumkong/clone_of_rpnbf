...
model.stage1_rpn.solver_def_file                = fullfile(pwd, 'models', exp_name, 'rpn_prototxts', 'vgg_16layers_yolo', 'solver_60k80k_widerface_conv4_yolo_inception.prototxt'); 
model.stage1_rpn.test_net_def_file              = fullfile(pwd, 'models', exp_name, 'rpn_prototxts', 'vgg_16layers_yolo', 'test_widerface_conv4_yolo_inception.prototxt');
