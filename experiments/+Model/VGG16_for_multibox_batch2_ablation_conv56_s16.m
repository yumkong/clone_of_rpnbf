function model = VGG16_for_multibox_batch2_ablation_conv56_s16(exp_name, model)
...
model.stage1_rpn.solver_def_file                = fullfile(pwd, 'models', exp_name, 'rpn_prototxts', 'vgg_16layers_ablation', 'stride16_exp', 'solver_30k40k_conv56_elmadd_s16.prototxt'); 
model.stage1_rpn.test_net_def_file              = fullfile(pwd, 'models', exp_name, 'rpn_prototxts', 'vgg_16layers_ablation', 'stride16_exp', 'test_conv56_elmadd_s16.prototxt');
