...
model.stage1_rpn.solver_def_file                = fullfile(pwd, 'models', exp_name, 'rpn_prototxts', 'vgg_16layers_ohem', 'solver_60k80k_widerface_conv4_ohem_plain.prototxt'); 
model.stage1_rpn.test_net_def_file              = fullfile(pwd, 'models', exp_name, 'rpn_prototxts', 'vgg_16layers_ohem', 'test_widerface_conv4_ohem_plain.prototxt');
