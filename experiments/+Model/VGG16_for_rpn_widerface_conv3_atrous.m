function model = VGG16_for_rpn_widerface_conv3_atrous(exp_name, model)
...
model.stage1_rpn.solver_def_file                = fullfile(pwd, 'models', exp_name, 'rpn_prototxts', 'vgg_16layers_conv3_final', 'solver_60k80k_widerface_conv3_atrous.prototxt'); 
model.stage1_rpn.test_net_def_file              = fullfile(pwd, 'models', exp_name, 'rpn_prototxts', 'vgg_16layers_conv3_final', 'test_widerface_conv3_atrous.prototxt');
