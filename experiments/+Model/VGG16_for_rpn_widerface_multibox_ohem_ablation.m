function model = VGG16_for_rpn_widerface_multibox_ohem_ablation(exp_name, model)
...
model.stage1_rpn.solver_def_file                = fullfile(pwd, 'models', exp_name, 'rpn_prototxts', 'vgg_16layers_final', 'solver_60k80k_widerface_multibox_ohem_conv34_ablation.prototxt'); 
model.stage1_rpn.test_net_def_file              = fullfile(pwd, 'models', exp_name, 'rpn_prototxts', 'vgg_16layers_final', 'test_widerface_multibox_ohem_conv34_ablation.prototxt');
