function model = VGG16_for_rpn_widerface_multibox_ohem_flip(exp_name, model)
...
model.stage1_rpn.solver_def_file                = fullfile(pwd, 'models', exp_name, 'rpn_prototxts', 'vgg_16layers_multibox', 'solver_60k80k_widerface_multibox_ohem_flip.prototxt'); 
model.stage1_rpn.test_net_def_file              = fullfile(pwd, 'models', exp_name, 'rpn_prototxts', 'vgg_16layers_multibox', 'test_widerface_multibox_ohem_flip.prototxt');
