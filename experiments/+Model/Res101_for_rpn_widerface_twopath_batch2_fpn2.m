function model = Res101_for_rpn_widerface_twopath_batch2_fpn2(exp_name, model)
...
model.stage1_rpn.solver_def_file                = fullfile(pwd, 'models', exp_name, 'rpn_prototxts', 'res101', 'solver_300k400k_fpn2.prototxt'); 
model.stage1_rpn.test_net_def_file              = fullfile(pwd, 'models', exp_name, 'rpn_prototxts', 'res101', 'test_fpn2.prototxt');
