function model = VGG16_for_multibox_batch2_ablation_divanchor_ohem(exp_name, model)
...
model.stage1_rpn.solver_def_file                = fullfile(pwd, 'models', exp_name, 'rpn_prototxts', 'vgg_16layers_ablation', 'final_models', 'solver_30k40k_final3_nodivanchor_ohem.prototxt'); 
model.stage1_rpn.test_net_def_file              = fullfile(pwd, 'models', exp_name, 'rpn_prototxts', 'vgg_16layers_ablation', 'final_models', 'test_final3_nodivanchor_ohem.prototxt');
