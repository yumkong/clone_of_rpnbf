function model = VGG16_for_mpfvn_ablation_total_conv2345_deconv_cxt(exp_name, model)
...
%0328 used new3
model.stage1_fast_rcnn.solver_def_file          = fullfile(pwd, 'models', exp_name,'rpn_prototxts', 'vgg_16layers_ablation', 'final_model_total','solver_60k80k_stage2_conv2345_deconv_cxt.prototxt');
model.stage1_fast_rcnn.test_net_def_file        = fullfile(pwd, 'models', exp_name,'rpn_prototxts', 'vgg_16layers_ablation', 'final_model_total', 'test_stage2_conv2345_deconv_cxt.prototxt');
end