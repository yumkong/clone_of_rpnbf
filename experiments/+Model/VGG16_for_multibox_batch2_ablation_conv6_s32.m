function model = VGG16_for_multibox_batch2_ablation_conv6_s32(exp_name, model)
...
model.stage1_rpn.solver_def_file                = fullfile(pwd, 'models', exp_name, 'rpn_prototxts', 'vgg_16layers_ablation', 'stride32_exp', 'solver_30k40k_conv6_stride32.prototxt'); 
model.stage1_rpn.test_net_def_file              = fullfile(pwd, 'models', exp_name, 'rpn_prototxts', 'vgg_16layers_ablation', 'stride32_exp', 'test_conv6_stride32.prototxt');
