function model = VGG16_for_multibox_batch2_ablation_fastrcnn_conv4(exp_name, model)
...
model.stage1_fast_rcnn.solver_def_file          = fullfile(pwd, 'models', exp_name,'rpn_prototxts', 'vgg_16layers_ablation', 'final_model_stage2','solver_60k80k_stage2_conv4.prototxt');
model.stage1_fast_rcnn.test_net_def_file        = fullfile(pwd, 'models', exp_name,'rpn_prototxts', 'vgg_16layers_ablation', 'final_model_stage2', 'test_stage2_conv4.prototxt');
end