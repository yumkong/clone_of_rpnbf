function model = VGG16_for_rpn_widerface_multibox_ohem_whole_unshared(exp_name, model)
...
model.stage1_rpn.solver_def_file                = fullfile(pwd, 'models', exp_name, 'rpn_prototxts', 'vgg_16layers_multibox', 'solver_60k80k_widerface_multibox_ohem.prototxt'); 
model.stage1_rpn.test_net_def_file              = fullfile(pwd, 'models', exp_name, 'rpn_prototxts', 'vgg_16layers_multibox', 'test_widerface_multibox_ohem.prototxt');
...
%% liu@1207 stage 1 fast rcnn, inited from stage 1 rpn
model.stage1_fast_rcnn.solver_def_file          = fullfile(pwd, 'models', exp_name,'rpn_prototxts', 'vgg_16layers_multibox_stage2', 'solver_60k80k_multibox_stage2_unshared_new.prototxt');
model.stage1_fast_rcnn.test_net_def_file        = fullfile(pwd, 'models', exp_name,'rpn_prototxts', 'vgg_16layers_multibox_stage2', 'test_multibox_stage2_unshared_new.prototxt');
end
