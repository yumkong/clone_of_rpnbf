function model = Res101_for_rpn_widerface_twopath_happy_flip_batch2(exp_name, model)
...
model.stage1_rpn.solver_def_file                = fullfile(pwd, 'models', exp_name, 'rpn_prototxts', 'res101', 'solver_300k400k.prototxt'); 
