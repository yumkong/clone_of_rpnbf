...
% model
model                       = Model.VGG16_for_rpn_widerface_conv4_iou_inception(exp_name, cache_base_proposal);
...
exp_name = 'VGG16_widerface_conv4_iou_inception'; %VGG16_widerface_twelve_anchors
