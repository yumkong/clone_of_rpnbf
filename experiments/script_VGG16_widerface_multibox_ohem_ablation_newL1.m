function script_VGG16_widerface_multibox_ohem_ablation_newL1()
...
opts.do_val                 = true; 
% model
model                       = Model.VGG16_for_rpn_widerface_multibox_ohem_ablation_newL1(exp_name);
% cache base
...
% %% -------------------- TRAIN --------------------
% conf
conf_proposal               = proposal_config_widerface_multibox_ohem_ablation_newL1('image_means', model.mean_image, ...
