function script_VGG16_widerface_ablation_fastrcnn_conv2345_deconv_ohem()
...
opts.do_val                 = true; 
% model
model                       = Model.VGG16_for_ablation_fastrcnn_conv2345_deconv_ohem(exp_name);
% cache base
...
exp_name = 'VGG16_widerface_multibox_ablation_final_fastrcnn_alter2';
...
model.stage1_fast_rcnn      = Faster_RCNN_Train.do_fast_rcnn_train_widerface_ablation_fastrcnn_ohem(conf_fast_rcnn, dataset, model.stage1_fast_rcnn, opts.do_val);
% test
