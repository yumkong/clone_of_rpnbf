function script_VGG16_widerface_ablation_mpfvn_total_conv2345_MALF()
...
opts.do_val                 = true; 
% model
model                       = Model.VGG16_for_mpfvn_ablation_MALF_conv2345_deconv(exp_name);
% cache base
...
%0106 use all test set for final evaluation: dataset.imdb_realtest
%dataset                     = Dataset.widerface_all(dataset, 'realtest', false, -1, cache_data_this_model_dir, model_name_base);
Faster_RCNN_Train.do_proposal_test_widerface_ablation_total_2345_MALF(conf_proposal, conf_fast_rcnn, model.stage1_rpn, model.stage1_fast_rcnn, nms_option_test);
end
