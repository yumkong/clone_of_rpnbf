function script_rpn_face_VGG16_widerface_multibox_final3_flip()
...
exp_name = 'VGG16_widerface_multibox_final3_flip';
...
method_name = 'RPN-ped';
nms_option_test = 3;
Faster_RCNN_Train.do_proposal_test_widerface_multibox_final3(conf_proposal, model.stage1_rpn, dataset.imdb_test, dataset.roidb_test, cache_name, method_name, nms_option_test);
