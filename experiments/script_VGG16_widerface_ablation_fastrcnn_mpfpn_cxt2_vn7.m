function script_VGG16_widerface_ablation_fastrcnn_mpfpn_cxt2_vn7()
...
opts.do_val                 = true; 
% model
model                       = Model.VGG16_for_ablation_fastrcnn_mpfpn_cxt_vn7(exp_name);
% cache base
...
conf_fast_rcnn              = fast_rcnn_config_widerface_mpfvn_batch2_vn7('image_means', model.mean_image);
...
model.stage1_fast_rcnn      = Faster_RCNN_Train.do_fast_rcnn_train_widerface_ablation_mpfvn_cxt2(conf_fast_rcnn, dataset, model.stage1_fast_rcnn, opts.do_val);
% test
Faster_RCNN_Train.do_fast_rcnn_test_widerface_ablation_mpfvn_cxt2(conf_fast_rcnn, model.stage1_fast_rcnn, dataset.imdb_test, dataset.roidb_test);
end
