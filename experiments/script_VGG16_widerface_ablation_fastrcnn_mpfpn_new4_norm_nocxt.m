function script_VGG16_widerface_ablation_fastrcnn_mpfpn_new4_norm_nocxt()
...
opts.do_val                 = true; 
% model
model                       = Model.VGG16_for_ablation_fastrcnn_mpfpn_new4_norm_nocxt(exp_name);
% cache base
...
exp_name = 'VGG16_widerface_mpfpn_final_fastrcnn_new2';
...
model.stage1_fast_rcnn      = Faster_RCNN_Train.do_fast_rcnn_train_widerface_ablation_mpfvn_nocxt(conf_fast_rcnn, dataset, model.stage1_fast_rcnn, opts.do_val);
% test
Faster_RCNN_Train.do_fast_rcnn_test_widerface_ablation_mpfvn_nocxt(conf_fast_rcnn, model.stage1_fast_rcnn, dataset.imdb_test, dataset.roidb_test);
end
