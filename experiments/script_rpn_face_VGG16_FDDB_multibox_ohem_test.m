...
% 0108 added: load BF detector
BF_cachedir = fullfile(pwd, 'output', exp_name, 'bf_cachedir_context_4x4_context_puck');  %puck
mkdir_if_missing(BF_cachedir);
prefix_name = fullfile(BF_cachedir, 'DeepCaltech_otf');
bf_detector_name = [prefix_name 'Detector.mat']; 
t = load(bf_detector_name); 
detector = t.detector; 
%0108 load caffe_net for feature extraction
BF_prototxt_path = fullfile('models', 'VGG16_widerface', 'bf_prototxts', 'test_feat_conv34atrous_multibox_ohem.prototxt');
