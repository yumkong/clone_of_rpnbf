function script_VGG16_ablation_fastrcnn_conv2345_deconv_cxt_ohem()
...
opts.do_val                 = true; 
% model
model                       = Model.VGG16_for_ablation_fastrcnn_conv2345_deconv_cxt_ohem(exp_name);
% cache base
...
model.stage1_fast_rcnn      = Faster_RCNN_Train.do_fast_rcnn_train_widerface_ablation_fastrcnn_cxt_ohem(conf_fast_rcnn, dataset, model.stage1_fast_rcnn, opts.do_val);
% test
