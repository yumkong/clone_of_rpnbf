function script_rpn_face_Res50_widerface_conv4()
...
opts.do_val                 = true; 
% model
model                       = Model.Res50_for_rpn_widerface_conv4(exp_name);
% cache base
...
model_name_base = 'res50_conv4';  % ZF, vgg16_conv5
%1009 change exp here for output
exp_name = 'Res50_widerface_conv4';
