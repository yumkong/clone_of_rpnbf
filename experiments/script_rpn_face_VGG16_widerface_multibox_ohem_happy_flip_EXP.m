function script_rpn_face_VGG16_widerface_multibox_ohem_happy_flip_EXP()
...
opts.do_val                 = true; 
% model
model                       = Model.VGG16_for_rpn_widerface_multibox_MPRPN(exp_name);
% cache base
...
exp_name = 'VGG16_widerface_MPRPN'; %VGG16_widerface_MPRPN_noohem, VGG16_widerface_MPRPN_noboth, VGG16_widerface_MPRPN_noatrous
