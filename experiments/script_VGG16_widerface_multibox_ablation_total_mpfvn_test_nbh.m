function script_VGG16_widerface_multibox_ablation_total_mpfvn_test_nbh()
...
Faster_RCNN_Train.do_proposal_test_widerface_ablation_final_mpfvn_nbh(conf_proposal,conf_fast_rcnn,  model.stage1_rpn,model.stage1_fast_rcnn, dataset.imdb_test, dataset.roidb_test, nms_option_test);
%0106 use all test set for final evaluation: dataset.imdb_realtest
