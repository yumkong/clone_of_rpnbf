function script_rpn_face_VGG16_widerface_conv3_6_atrous()
...
opts.do_val                 = true; 
% model
model                       = Model.VGG16_for_rpn_widerface_conv3_6_atrous(exp_name);
% cache base
...
model_name_base = 'vgg16_conv3_6';  % ZF, vgg16_conv5
%1009 change exp here for output
exp_name = 'VGG16_widerface_conv3_6_atrous';
...
output_map_name = 'output_map_conv6';  % output_map_conv3, output_map_conv5
