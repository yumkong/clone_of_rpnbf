function script_rpn_face_VGG16_widerface_conv4_atrous()
...
opts.do_val                 = true; 
% model
model                       = Model.VGG16_for_rpn_widerface_conv4_atrous(exp_name);
% cache base
...
exp_name = 'VGG16_widerface_conv4_atrous_reduce3';
