function script_rpn_bf_face_VGG16_widerface_conv4_hwRatio()
...
conf_proposal.anchors = proposal_generate_anchors(cache_data_this_model_dir, 'ratios', [1.25, 0.8], 'scales',  2.^[-1:5]);
...
opts.nNeg = 8000;  % #neg needed by every stage  1020: 5000 --> 8000
opts.nAccNeg = 90000;  % #accumulated neg from stage2 -- 7 % 50000-->60000 --> 90000
...
opts.fg_use_gt = true;
opts.bg_nms_thres = 1;
opts.max_rois_num_in_gpu = 5000;  %3000 --> 5000
opts.init_detector = '';
opts.load_gt = false;
