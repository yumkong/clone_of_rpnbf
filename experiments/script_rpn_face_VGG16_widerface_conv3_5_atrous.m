function script_rpn_face_VGG16_widerface_conv3_5_atrous()
...
opts.do_val                 = true; 
% model
model                       = Model.VGG16_for_rpn_widerface_conv3_5_atrous(exp_name);
% cache base
...
model_name_base = 'vgg16_conv3_5';  % ZF, vgg16_conv5
%1009 change exp here for output
exp_name = 'VGG16_widerface_conv3_5_atrous';
...
model.stage1_rpn            = Faster_RCNN_Train.do_proposal_train_widerface_conv3_4(conf_proposal, dataset, model.stage1_rpn, opts.do_val);
