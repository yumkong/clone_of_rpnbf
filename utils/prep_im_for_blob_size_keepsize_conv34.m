function im_scale = prep_im_for_blob_size_keepsize_conv34(im_size, input_scale, min_size, max_size)
    
    %0131 always keep the original scale, large im will be split later
