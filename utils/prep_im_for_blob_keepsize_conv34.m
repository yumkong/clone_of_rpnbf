function [im, im_scale] = prep_im_for_blob_keepsize_conv34(im, im_means, input_scale, min_size, max_size)
%function [im, im_scale] = prep_im_for_blob_keepsize(im, im_means, target_size, max_size)
    ...
    if ~isa(im, 'gpuArray')
        ...
        im_scale = prep_im_for_blob_size_keepsize_conv34(size(im), input_scale, min_size, max_size);
        ...
        %0131 added: pad to be 8x
        new_target_size = ceil(target_size / 8) * 8;%32
