function [im, im_scale] = prep_im_for_blob_keepsize_MALF(im, im_means, input_scale, min_size, max_size)
%function [im, im_scale] = prep_im_for_blob_keepsize(im, im_means, target_size, max_size)
    ...
    if ~isa(im, 'gpuArray')
        ...
        im_scale = prep_im_for_blob_size_keepsize_MALF(size(im), input_scale, min_size, max_size);
