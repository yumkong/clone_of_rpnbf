function [feats] = rois_get_features_ratio_5x5_face_region(conf, caffe_net, im, boxes, max_rois_num_in_gpu, ratio)
...
%     top_ratio = 0.5; %1229: 0.2--> 0.5
%     bottom_ratio = 0.5; %1229: 0.8 --> 0.5
